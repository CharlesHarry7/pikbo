...
export function SoftLaunchStrip() {
  ...
  return (
    <div
      className="border-b border-[var(--brand)]/25 bg-gradient-to-r from-[var(--brand)]/[0.12] via-black to-black px-3 py-2.5 sm:px-5"
      data-soft-launch-boot={sessionBoot}
    >
      <div className="mx-auto flex max-w-[1400px] flex-wrap items-center justify-between gap-2">
        <p className="text-[12px] leading-snug text-white/80 sm:text-[13px]">
          <span className="font-black text-[var(--brand)]">{badgeLabel}</span>
