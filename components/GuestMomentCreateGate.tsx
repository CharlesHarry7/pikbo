            ...
            {sessionBoot === "timeout" ? (
              ...
              >
                ...
                <button
                  ...
                  className="mt-2 inline-flex min-h-10 items-center justify-center rounded-full bg-white px-4 text-[10px] font-black uppercase tracking-[0.12em] text-black transition hover:bg-[var(--neon-pink)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00D9FF]"
                >
                  Retry access check
                </button>
              </div>
