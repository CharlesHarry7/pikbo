...
function GuestMomentPreview({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_45%,rgba(196,165,116,0.12),transparent_34%),linear-gradient(90deg,rgba(8,8,10,0.98)_0%,rgba(8,8,10,0.64)_50%,rgba(8,8,10,0.96)_100%)]"
        aria-hidden
      />
      ...
      <div className="mx-auto grid max-w-[1360px] gap-7 lg:min-h-[calc(100vh-7rem)] lg:grid-cols-[minmax(220px,0.75fr)_minmax(330px,390px)_minmax(260px,0.78fr)] lg:items-center lg:gap-10 xl:gap-14">
        ...
        >
          <div className="relative rounded-[30px] border border-white/12 bg-[var(--card)] p-2 shadow-[0_42px_120px_-42px_rgba(196,165,116,0.28)]">
            ...
            {sessionBoot === "timeout" ? (
              ...
              >
                ...
                <button
                  ...
                  className="mt-2 inline-flex min-h-10 items-center justify-center rounded-full bg-white px-4 text-[10px] font-black uppercase tracking-[0.12em] text-[var(--void)] transition hover:bg-[var(--mint)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/50"
                >
                  Retry access check
                </button>
              </div>
            ...
            <div className="mt-5 grid gap-3">
              {!signedIn && (
                <Link
                  ...
                  className="btn-press inline-flex min-h-14 items-center justify-between rounded-2xl bg-[var(--grad-cta)] px-5 text-xs font-black uppercase tracking-[0.12em] text-[var(--primary-foreground)] shadow-[0_12px_40px_-12px_rgba(196,165,116,0.35)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--void)]"
                >
