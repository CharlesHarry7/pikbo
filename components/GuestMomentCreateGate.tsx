    ...
    >
      ...
      <div className="mx-auto grid max-w-[1360px] gap-7 lg:min-h-[calc(100vh-7rem)] lg:grid-cols-[minmax(220px,0.75fr)_minmax(330px,390px)_minmax(260px,0.78fr)] lg:items-center lg:gap-10 xl:gap-14">
        <div className="order-2 max-w-[380px] lg:order-1">
          <p className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--neon-pink)]">
            Current motion
          </p>
            ...
            {sessionBoot === "timeout" ? (
              ...
              >
                ...
                <button
                  ...
                  className="mt-2 inline-flex min-h-10 items-center justify-center rounded-full bg-white px-4 text-[10px] font-black uppercase tracking-[0.12em] text-[var(--void)] transition hover:bg-[var(--mint)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--tide-blue)]"
                >
                  Retry access check
                </button>
              </div>
            ...
            <div className="mt-5 grid gap-3">
              {!signedIn && (
                <Link
                  ...
                  className="btn-press inline-flex min-h-14 items-center justify-between rounded-2xl bg-[var(--grad-cta)] px-5 text-xs font-black uppercase tracking-[0.12em] text-[var(--void)] shadow-[0_12px_40px_-12px_rgba(196,165,116,0.35)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--tide-blue)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--void)]"
                >
              ...
              <a
                ...
                className={`inline-flex min-h-12 items-center justify-center rounded-2xl border px-5 text-[10px] font-black uppercase tracking-[0.14em] transition hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white ${
                  signedIn
                    ? "border-[var(--neon-pink)] bg-[var(--grad-cta)] text-[var(--void)]"
