      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded-full border border-[var(--mint)]/40 bg-[var(--mint)]/12 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-[var(--mint)] shadow-[0_0_20px_color-mix(in_srgb,var(--neon-pink)_16%,transparent)]">
              {t("suite.toyStudio")}
            </span>
            {isImage ? (
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "border-[var(--mint)] bg-[var(--mint)]/15 text-[var(--mint)] shadow-[0_0_24px_color-mix(in_srgb,var(--neon-pink)_16%,transparent)]"
