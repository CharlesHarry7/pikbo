      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded-full border border-[var(--brand)]/40 bg-[var(--brand)]/12 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-[var(--brand)] shadow-[0_0_20px_rgba(196,165,116,0.12)]">
              {t("suite.toyStudio")}
            </span>
            {isImage ? (
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "border-[var(--brand)] bg-[var(--brand)]/15 text-[var(--brand)] shadow-[0_0_24px_rgba(196,165,116,0.12)]"
