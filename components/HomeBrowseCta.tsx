  ...
  return (
    ...
    >
      <Link
        ...
        className={`pointer-events-auto flex w-full max-w-md items-center justify-between gap-3 rounded-2xl border border-neon-pink/50 bg-black/92 px-4 py-3 shadow-[0_0_40px_color-mix(in_srgb,var(--neon-pink)_22%,transparent),0_12px_40px_rgba(0,0,0,0.55)] backdrop-blur-xl transition hover:border-neon-pink hover:bg-black sm:max-w-lg ${
          visible ? "" : "pointer-events-none"
        }`}
      >
        <span className="min-w-0 text-left">
          <span className="block section-label tracking-[0.14em]">
        ...
        <span className="shrink-0 cta-brand rounded-full px-4 py-2 text-xs font-black">
