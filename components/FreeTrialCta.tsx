...
const VARIANT_CLASS: Record<Variant, string> = {
  primary:
    "rounded-full bg-[var(--mint)] px-5 py-2.5 text-xs font-black text-black shadow-[0_0_28px_color-mix(in_srgb,var(--mint)_22%,transparent)] transition hover:-translate-y-0.5",
