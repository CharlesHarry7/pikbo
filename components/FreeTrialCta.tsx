...
const VARIANT_CLASS: Record<Variant, string> = {
  primary:
    // Gallery copper board (parity SoftLaunchStrip money CTA) — not competitor lime.
    "rounded-full bg-[var(--brand)] px-5 py-2.5 text-xs font-black text-[var(--primary-foreground)] shadow-[0_0_28px_rgba(196,165,116,0.22)] transition hover:-translate-y-0.5",
