...
export function FlowMediaCard({
  ...
  return (
    <Link
      href={href}
      className="group relative overflow-hidden rounded-2xl bg-neutral-900 ring-1 ring-white/10 transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_-28px_rgba(255,78,205,0.2)] hover:ring-[var(--neon-pink)]/50"
    ...
    >
      <div className="relative aspect-video overflow-hidden">
        ...
        <span className="absolute bottom-2 left-2 translate-y-1 rounded-full bg-[var(--neon-pink)] px-2.5 py-1 text-[10px] font-black text-[var(--void)] opacity-0 shadow-[0_0_20px_rgba(255,78,205,0.35)] transition duration-300 group-hover:translate-y-0 group-hover:opacity-100">
          {ctaLabel}
        </span>
      </div>
      <div className="p-4">
