        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="mt-3 flex flex-wrap gap-3">
            <Link
              ...
              className="text-[11px] font-bold text-[var(--tide-blue)] hover:underline"
              onClick={() =>
                track({
                  event: "recipe_use",
                  path: "/",
            ...
            return (
              <Link
                ...
                className={`group relative h-[9.5rem] w-[7.5rem] shrink-0 overflow-hidden rounded-2xl border transition duration-200 hover:-translate-y-0.5 sm:h-[11rem] sm:w-[9rem] ${
                  is360
                    ? "border-[var(--tide-blue)]/45 shadow-[0_0_28px_rgba(138,143,152,0.12)]"
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-2.5">
                  <div className="flex flex-wrap gap-1">
                    ...
                    {is360 ? (
                      <span className="inline-flex rounded-full bg-[var(--tide-blue)] px-1.5 py-0.5 text-[8px] font-black uppercase tracking-wide text-black">
                        360
                      </span>
                    ) : null}
                  </div>
