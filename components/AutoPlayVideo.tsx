      ...
      {showControls ? (
        ...
        >
          <button
            ...
            className="grid h-10 w-10 place-items-center rounded-full border border-white/25 bg-black/65 text-white shadow-lg backdrop-blur transition hover:border-white/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--neon-pink)]"
      ...
      {errorRetry && mediaError ? (
        ...
        >
          ...
          <button
            ...
            className="mt-2 inline-flex min-h-10 items-center justify-center rounded-full bg-white px-4 text-[10px] font-black uppercase tracking-[0.12em] text-[var(--void)] transition hover:bg-[var(--neon-pink)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--neon-pink)]"
          >
            Retry Lab preview
          </button>
        </div>
