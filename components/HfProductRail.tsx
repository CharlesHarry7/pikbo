    ...
    <section className="border-b border-white/10 bg-black px-3 py-5 sm:px-5">
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="flex gap-2.5 overflow-x-auto pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          <div className="group relative h-[9.5rem] w-[8.5rem] shrink-0 overflow-hidden rounded-2xl border border-neon-pink/45 bg-neon-pink/[0.1] p-3.5 shadow-[0_0_32px_rgba(255,78,205,0.12)] sm:h-[11rem] sm:w-[10rem]">
            <span className="relative z-10 inline-flex rounded-full bg-neon-pink px-1.5 py-0.5 text-[9px] font-black uppercase tracking-wide text-void">
              Free
            </span>
            ...
            return (
              <Link
                ...
                className={`group relative h-[9.5rem] w-[8.5rem] shrink-0 overflow-hidden rounded-2xl border transition duration-200 hover:-translate-y-0.5 sm:h-[11rem] sm:w-[10rem] ${
                  p.hot
                    ? "border-neon-pink/50 shadow-[0_0_32px_rgba(255,78,205,0.14)]"
