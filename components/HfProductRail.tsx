 ...
 * Below-fold suite density under Moment hero (AIT-241 / AIT-299).
    ...
    >
      <div className="mx-auto max-w-[1400px]">
        <div className="mb-3 flex items-end justify-between gap-2">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2 sm:gap-3">
            ...
            <FreeTrialCta
              ...
              hideClipsChip
              className="rounded-full border border-white/20 bg-transparent px-3 py-1.5 text-[11px] font-bold text-white/70 transition hover:border-[var(--neon-pink)]/40 hover:text-white"
            />
            {/* One primary Generate → 360 (AIT-299 / AIT-272). */}
            <Link
              href={GENERATE_REMIX_HREF}
              className="rounded-full bg-[linear-gradient(135deg,#00D9FF,#00FFA3)] px-4 py-2 text-[11px] font-black text-black shadow-[0_0_24px_rgba(0,217,255,0.28)] transition hover:-translate-y-0.5 hover:shadow-[0_0_32px_rgba(0,217,255,0.4)]"
        ...
        <div className="flex gap-2.5 overflow-x-auto pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {/* Free Mini honesty card — secondary outline; caps only when freeLiveOpen. */}
          <div className="group relative h-[9.5rem] w-[8.5rem] shrink-0 overflow-hidden rounded-2xl border border-white/15 bg-white/[0.03] p-3.5 transition hover:border-white/30 sm:h-[11rem] sm:w-[10rem]">
            ...
            <p className="relative z-10 mt-2 text-[13px] font-black leading-tight text-white">
              <FreeTrialCta
                ...
                labelPlans="Plans"
                hideClipsChip
                className="font-black text-white/90 underline-offset-2 group-hover:text-[var(--neon-pink)] group-hover:underline"
              />
            </p>
            <p
