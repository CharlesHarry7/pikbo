    ...
    <ToastCtx.Provider value={value}>
      ...
      <div className="pointer-events-none fixed bottom-20 right-4 z-[120] flex max-w-[min(22rem,calc(100vw-2rem))] flex-col gap-2 lg:bottom-6">
        {items.map((t) => (
          <div
            key={t.id}
            className="pointer-events-auto rounded-xl border border-[var(--neon-pink)]/25 bg-[#0c0c10]/95 px-4 py-2.5 text-sm font-medium text-white shadow-[0_12px_40px_-12px_rgba(0,0,0,0.8),0_0_24px_rgba(255,78,205,0.08)] backdrop-blur-md"
          >
