...
export function VideoTile({
  ...
  return (
    <Link
      href={item.href}
      className="video-tile group block overflow-hidden rounded-xl border border-white/[0.08] bg-black shadow-[0_12px_32px_-14px_rgba(0,0,0,0.85)] transition duration-300 hover:-translate-y-0.5 hover:border-[var(--neon-pink)]/45 hover:shadow-[0_20px_48px_-16px_rgba(255,78,205,0.12)]"
      ...
      <div className={`relative ${aspectClass(item.ratio, compact)}`}>
        ...
        >
          ...
          {compact ? (
            ...
            <p className="mt-1.5 inline-flex items-center gap-1 rounded-full bg-[var(--neon-pink)]/15 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-[var(--neon-pink)] ring-1 ring-[var(--neon-pink)]/30 transition group-hover:bg-[var(--neon-pink)] group-hover:text-[var(--void)]">
