...
export function VideoTile({
  ...
  return (
    <Link
      href={item.href}
      className="video-tile group block overflow-hidden rounded-xl border border-white/[0.08] bg-black shadow-[0_12px_32px_-14px_rgba(0,0,0,0.85)] transition duration-300 hover:-translate-y-0.5 hover:border-neon-pink/45 hover:shadow-[0_20px_48px_-16px_rgba(255,78,205,0.12)]"
