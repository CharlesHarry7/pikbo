...
export function PricingPlanCards() {
  ...
  return (
    <Card
      ...
      className="relative mx-auto flex max-w-2xl scroll-mt-24 flex-col overflow-hidden border-[var(--mint)]/40 shadow-[0_0_0_1px_color-mix(in_srgb,var(--neon-pink)_22%,transparent),0_24px_60px_-24px_rgba(0,0,0,0.85)]"
