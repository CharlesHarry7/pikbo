      ...
      <section className="px-3 pb-16 sm:px-5" aria-live="polite">
        <div className="columns-2 gap-2 sm:columns-3 sm:gap-3 lg:columns-4 xl:columns-5">
          {visible.map((project, index) => (
            <article
              key={project.slug}
              className="group relative mb-2 break-inside-avoid overflow-hidden rounded-2xl border border-white/[0.08] bg-neutral-950 shadow-[0_12px_32px_-18px_rgba(0,0,0,0.9)] transition duration-300 hover:-translate-y-0.5 hover:border-[var(--neon-pink)]/35 hover:shadow-[0_20px_40px_-20px_rgba(255,78,205,0.12)] sm:mb-3"
            >
              <Link
