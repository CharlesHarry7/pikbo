...
export function GenerateWaitStage({
  ...
  return (
    ...
    >
      {/* Soft stage glow — neon-pink board wash (not competitor lime) */}
      <div
      ...
      {image ? (
        <div className="relative mb-4">
          ...
          <img
            ...
            className={`rounded-2xl object-cover ring-2 ring-[var(--mint)]/40 shadow-[0_0_32px_rgba(255,78,205,0.2)] ${
              compact ? "h-16 w-16" : "h-[5.5rem] w-[5.5rem]"
            }`}
          />
          <span className="absolute -bottom-1 -right-1 grid h-6 w-6 place-items-center rounded-full bg-[var(--mint)] text-[10px] font-black text-[var(--void)] shadow-[0_0_12px_rgba(255,78,205,0.5)]">
