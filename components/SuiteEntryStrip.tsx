          ...
          {ENTRY_DEFS.map((e) => (
            <Link
              ...
              className={`group relative overflow-hidden rounded-2xl border px-3 py-3.5 transition duration-200 hover:-translate-y-0.5 ${
                "hot" in e && e.hot
                  ? "border-[var(--brand)]/40 bg-[var(--brand)]/[0.09] shadow-[0_0_32px_rgba(196,165,116,0.08)] hover:shadow-[0_0_40px_rgba(196,165,116,0.14)]"
                  : "border-white/10 bg-white/[0.03] hover:border-white/20 hover:bg-white/[0.05]"
              }`}
            >
              <span
                className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[var(--brand)]/50 to-transparent opacity-0 transition group-hover:opacity-100"
                aria-hidden
              />
