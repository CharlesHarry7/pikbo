    ...
    <section className="border-b border-white/10 bg-gradient-to-b from-[#0c0c14] via-[#08080c] to-black px-3 py-8 sm:px-5">
      <div className="mx-auto max-w-6xl">
        <div className="mb-4 flex flex-wrap items-end justify-between gap-2">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-neon-pink">
              {t(titleKey)}
            </p>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <FreeTrialCta
              ...
              hideClipsChip
              className="text-[11px] font-semibold text-neon-pink hover:underline"
            />
            <Link
              href="/flow"
          ...
          {ENTRY_DEFS.map((e) => (
            <Link
              ...
              className={`group relative overflow-hidden rounded-2xl border px-3 py-3.5 transition duration-200 hover:-translate-y-0.5 ${
                "hot" in e && e.hot
                  ? "border-neon-pink/40 bg-neon-pink/[0.09] shadow-[0_0_32px_rgba(255,78,205,0.08)] hover:shadow-[0_0_40px_rgba(255,78,205,0.14)]"
                  : "border-white/10 bg-white/[0.03] hover:border-white/20 hover:bg-white/[0.05]"
              }`}
            >
              <span
                className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-neon-pink/50 to-transparent opacity-0 transition group-hover:opacity-100"
                aria-hidden
              />
