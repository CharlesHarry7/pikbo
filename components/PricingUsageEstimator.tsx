...
export function PricingUsageEstimator() {
  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-white/10 bg-bg-soft shadow-[0_30px_80px_-45px_color-mix(in_srgb,var(--neon-pink)_45%,transparent)]">
