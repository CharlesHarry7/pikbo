    ...
    >
      <div className="mx-auto mb-7 flex max-w-[1600px] items-end justify-between gap-6 px-2 sm:mb-9">
        <div className="max-w-3xl">
          <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#c4a574]">
            {HOME_PROOF_BADGE}
          </p>
          <h2
        ...
        <div className="hidden shrink-0 flex-col items-end gap-2 sm:flex">
          <Link
            href={momentHref}
            className="rounded-full border border-[#c4a574]/35 bg-[rgba(196,165,116,0.1)] px-5 py-2.5 text-xs font-black text-[#c4a574] transition hover:border-[#c4a574]/50 hover:text-[#c4a574]"
          >
            Create a Moment ↗
          </Link>
          <Link
            ...
            className="rounded-full border border-[#c4a574]/35 bg-[rgba(196,165,116,0.08)] px-5 py-2 text-[10px] font-black uppercase tracking-[0.12em] text-[#c4a574] transition hover:border-[#c4a574]/60"
            onClick={() =>
              track({
                event: "recipe_use",
                path: "/",
        ...
        {wall.map((item, index) => {
          ...
          return (
            <article
              ...
              className="toy-card group relative isolate aspect-[4/5] min-w-0 overflow-hidden p-1.5 transition duration-200 hover:scale-[1.02] focus-within:ring-2 focus-within:ring-[#c4a574]"
            >
              <div className="relative h-full w-full overflow-hidden rounded-[1.35rem] bg-[#0A0A0F]">
                <Link
                  ...
                  className="absolute inset-0 z-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#c4a574]"
                  onClick={() =>
                    track({
                ...
                >
                  ...
                  {is360 ? (
                    <span
                      data-home-proof-360
                      className="absolute right-2 top-2 rounded-full border border-[#c4a574]/40 bg-[#c4a574]/15 px-2 py-1 text-[8px] font-black uppercase tracking-[0.12em] text-[#c4a574] backdrop-blur sm:right-3 sm:top-3 sm:text-[9px]"
                    >
                      360 spin
                    </span>
                  ) : null}
                ...
                <Link
                  ...
                  className="absolute bottom-3 left-3 z-20 inline-flex items-center gap-1.5 rounded-full bg-[linear-gradient(135deg,#c4a574,#a89070)] px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.1em] text-white shadow-[0_0_18px_rgba(196,165,116,0.35)] transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c4a574] sm:bottom-4 sm:left-4 sm:text-[10px]"
                  onClick={() =>
                    track({
                      event: "recipe_use",
                      path: "/",
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-2 sm:hidden">
        <Link
          href={momentHref}
          className="rounded-full border border-[#c4a574]/35 px-5 py-2.5 text-xs font-bold text-[#c4a574]"
        >
          Create a Moment
        </Link>
        <Link
          href={listing360Href}
          data-home-proof-360-cta
          className="rounded-full border border-[#c4a574]/35 px-4 py-2.5 text-[10px] font-black uppercase tracking-[0.1em] text-[#c4a574]"
          onClick={() =>
            track({
              event: "recipe_use",
              path: "/",
