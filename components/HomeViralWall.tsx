    ...
    >
      <div className="mx-auto mb-7 flex max-w-[1600px] items-end justify-between gap-6 px-2 sm:mb-9">
        ...
        <div className="hidden shrink-0 flex-col items-end gap-2 sm:flex">
          ...
          <Link
            ...
            className="rounded-full bg-[linear-gradient(135deg,#00D9FF,#00FFA3)] px-5 py-2.5 text-xs font-black uppercase tracking-[0.1em] text-black shadow-[0_0_28px_rgba(0,217,255,0.35)] transition hover:brightness-110"
            onClick={() =>
              track({
                event: "recipe_use",
                path: "/",
          ...
          <Link
            href={momentHref}
            className="rounded-full border border-[#FF4ECD]/35 bg-[rgba(255,78,205,0.08)] px-5 py-2 text-[10px] font-black uppercase tracking-[0.12em] text-[#FF4ECD] transition hover:border-[#FF4ECD]/60"
          >
            Create a Moment
          </Link>
        </div>
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-2 sm:hidden">
        <Link
          ...
          data-home-proof-360-cta
          data-home-primary-generate-cta
          className="rounded-full bg-[linear-gradient(135deg,#00D9FF,#00FFA3)] px-5 py-2.5 text-xs font-black uppercase tracking-[0.1em] text-black shadow-[0_0_24px_rgba(0,217,255,0.3)]"
          onClick={() =>
            track({
              event: "recipe_use",
              path: "/",
