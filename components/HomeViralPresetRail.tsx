    ...
    <section className="border-b border-white/10 px-3 py-10 sm:px-5">
      <div className="mx-auto max-w-6xl">
        <div className="mb-4 flex flex-wrap items-end justify-between gap-2">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--neon-pink)]/90">
        ...
        <div className="flex gap-2.5 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {clips.map((d) => (
            <Link
              ...
              className="group relative w-[9.5rem] shrink-0 overflow-hidden rounded-2xl bg-neutral-900 ring-1 ring-white/10 transition duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_16px_40px_-12px_rgba(224,179,92,0.18)] hover:ring-[var(--neon-pink)]/50 sm:w-[11.5rem]"
            >
              <div className="relative aspect-[3/4]">
                ...
                <div className="absolute left-2 top-2 flex max-w-[88%] flex-wrap gap-0.5">
                  <span className="rounded-full bg-black/60 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wide text-[var(--neon-pink)] backdrop-blur-sm">
                    {d.eyebrow}
                  </span>
                  <span
                ...
                <div className="absolute inset-x-0 bottom-0 p-2.5">
                  ...
                  <p className="mt-1.5 text-[9px] font-bold uppercase tracking-wide text-[var(--neon-pink)] opacity-0 transition group-hover:opacity-100">
                    {t("home.yourPhoto")}
                  </p>
                </div>
              </div>
