      ...
      <form className="space-y-3.5" onSubmit={(e) => void onSubmit(e)}>
        <label className="block text-[10px] font-black uppercase tracking-[0.16em] text-white/55">
          ...
          <input
            ...
            className="login-email-field mt-2 w-full rounded-xl border border-white/12 bg-black/45 px-3.5 py-3 text-sm font-semibold text-white outline-none placeholder:text-white/28 focus:border-[var(--brand)] focus:shadow-[0_0_0_3px_rgba(196,165,116,0.18)]"
          />
        </label>
        <button
          type="submit"
