      ...
      >
        {onRetry ? (
          <button
            ...
            className="rounded-full bg-[var(--neon-pink)] px-3.5 py-1.5 text-[11px] font-black text-[var(--void)] shadow-[0_0_16px_rgba(255,78,205,0.3)] transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-40"
          >
