...
export function CreateStudio({
  ...
  return (
    ...
    >
      ...
      {/* ── Mode banner: demo vs live (W5) · AIT-312: single-row on workbench mobile ── */}
      <div
        role="status"
      ...
      >
        ...
        >
          ...
          {/* AIT-312: hide secondary access row on workbench phone — saves a wrap line */}
          <div
      ...
      {/* ── Remix context (from Home / project deep link) · AIT-312: compact on mobile ── */}
      {!fixedMomentContract &&
      ...
      {/* ── Mobile first-run steps · AIT-312: workbench compact path chrome ── */}
      <div
      ...
      >
        ...
        {/* ── Controls: upload → recipe → preflight (AIT-312 tighter on workbench) ── */}
        <section
