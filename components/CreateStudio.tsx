    ...
    <div className="flex h-full min-h-[calc(100vh-3.5rem)] flex-col pb-36 lg:min-h-screen lg:pb-0">
      ...
      >
        ...
        <aside className="hidden">
          <p className="mb-0.5 px-1 text-[10px] font-black uppercase tracking-[0.16em] text-[var(--mint)]/90">
            Toy recipes
          </p>
          ...
          <input
            ...
            className="mb-2 w-full rounded-lg border border-white/10 bg-black/50 px-2.5 py-2 text-xs outline-none focus:border-[var(--mint)]/50 focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--mint)_12%,transparent)]"
          />
            ...
            {featuredPresets.map((p) => (
              <div
                ...
                className={`flex items-stretch gap-1 rounded-xl border transition duration-150 ${
                  effect === p.slug
                    ? "border-[var(--mint)]/60 bg-[var(--mint)]/[0.08] shadow-[0_0_24px_color-mix(in_srgb,var(--mint)_14%,transparent)]"
        ...
        <section className="space-y-4 overflow-y-auto border-b border-white/[0.07] bg-[#08080a] p-4 lg:max-h-[calc(100vh-8rem)] lg:border-b-0 lg:border-r">
              ...
              <label
                className={`group/drop relative flex cursor-pointer flex-col items-center justify-center overflow-hidden rounded-2xl border border-dashed bg-black/40 transition-all duration-200 hover:border-[var(--mint)]/55 hover:bg-black/55 ${
                  image
                    ...
                    : "min-h-[160px] border-[var(--mint)]/40 shadow-[0_0_40px_color-mix(in_srgb,var(--mint)_10%,transparent)] sm:aspect-video"
                }`}
          ...
          {!fixedMomentContract ? <div
            className="rounded-xl border border-[var(--mint)]/20 bg-gradient-to-br from-[var(--mint)]/[0.07] to-black/40 p-3 shadow-[inset_0_1px_0_color-mix(in_srgb,var(--mint)_12%,transparent)]"
          >
          ...
          <div className="media-stage relative flex min-h-[280px] flex-1 items-center justify-center overflow-hidden sm:min-h-[420px]">
            ...
            {(status === "done" || status === "error") && videoUrl && (
              <div className="relative w-full p-3">
                ...
                <div className="mx-auto mt-4 max-w-md rounded-2xl border border-[var(--mint)]/35 bg-gradient-to-b from-[var(--mint)]/[0.12] to-black/40 px-4 py-3.5 text-center shadow-[0_0_40px_color-mix(in_srgb,var(--mint)_14%,transparent)]">
