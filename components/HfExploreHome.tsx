...
export function HfExploreHome({
  ...
  if (!item) {
    return (
      <div className="min-h-screen bg-void px-4 py-20 text-center text-white">
  ...
  return (
    <div
      className={`bg-void text-cream sm:pb-16 ${
    ...
    >
      ...
      <section className="relative min-h-[min(320px,45svh)] overflow-hidden border-b border-white/10 sm:min-h-[min(420px,55svh)]">
        ...
        <div className="relative mx-auto flex min-h-[min(420px,50svh)] max-w-6xl flex-col justify-end px-4 pb-8 pt-12 sm:min-h-[min(520px,55svh)] sm:px-6 sm:pb-12 sm:pt-16">
          ...
          <span className="mt-3 inline-flex w-fit items-center rounded-full border border-neon-pink/30 bg-black/60 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide text-neon-pink shadow-[0_0_24px_color-mix(in_srgb,var(--neon-pink)_18%,transparent)] backdrop-blur">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full cta-brand px-7 py-3.5 text-sm font-black shadow-[0_0_48px_-6px_color-mix(in_srgb,var(--neon-pink)_55%,transparent)]"
            >
      ...
      <section className="border-b border-white/10 bg-gradient-to-b from-black via-bg-soft to-black px-3 py-12 sm:px-5">
        <div className="mx-auto max-w-5xl">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-neon-pink/90">
            {t("home.proof")}
          </p>
            ...
            <div className="overflow-hidden rounded-2xl bg-neutral-950 ring-1 ring-neon-pink/25 shadow-[0_24px_60px_-24px_color-mix(in_srgb,var(--neon-pink)_20%,transparent)]">
              <div className="relative aspect-[4/5]">
                <Clip
                  ...
                  className="absolute inset-0 h-full w-full object-cover"
                />
                <span className="absolute left-3 top-3 rounded-full cta-brand px-2 py-0.5 text-[9px] font-black uppercase tracking-wide shadow-[0_0_16px_color-mix(in_srgb,var(--neon-pink)_40%,transparent)]">
                  Preview
                </span>
              </div>
          ...
          <div className="mt-7 flex flex-wrap gap-2">
            <Link
              href={item.href}
              className="inline-flex rounded-full cta-brand px-7 py-3.5 text-sm font-black shadow-[0_0_40px_-8px_color-mix(in_srgb,var(--neon-pink)_50%,transparent)] transition hover:-translate-y-0.5"
            >
              {t("home.replaceMine")}
            </Link>
            <Link
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:gap-3">
            {projects.slice(0, 8).map((project, i) => (
              <div
                key={project.slug}
                className="group relative overflow-hidden rounded-xl bg-neutral-900 ring-1 ring-white/10 shadow-[0_12px_32px_-18px_rgba(0,0,0,0.85)] transition duration-300 hover:-translate-y-1 hover:ring-neon-pink/45 hover:shadow-[0_20px_40px_-20px_color-mix(in_srgb,var(--neon-pink)_14%,transparent)]"
              >
                <button
                  type="button"
                ...
                <div className="absolute inset-x-0 bottom-0 flex gap-1 p-2">
                  <Link
                    ...
                    className="flex-1 rounded-full cta-brand py-1.5 text-center text-[10px] font-black shadow-[0_0_16px_color-mix(in_srgb,var(--neon-pink)_25%,transparent)] transition hover:brightness-110"
                  >
                    {t("home.remake")}
                  </Link>
                  <Link
      ...
      <section className="border-b border-white/10 px-3 py-8 sm:px-5">
        <div className="mx-auto max-w-6xl">
          <div className="mb-4 flex flex-wrap items-end justify-between gap-2">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-neon-pink">
                Creation flow
              </p>
              <h2 className="font-display text-xl font-bold uppercase tracking-tight sm:text-2xl">
      ...
      <section className="px-3 pb-10 text-center sm:px-5">
        ...
        <Link
          href={item.href}
          className="inline-flex items-center justify-center rounded-full cta-brand px-8 py-3 text-sm font-black"
        >
