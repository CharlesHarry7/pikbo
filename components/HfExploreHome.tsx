    ...
    return (
      <div className="min-h-screen bg-black px-4 py-20 text-center text-white">
        ...
        <Link
          ...
          className="mt-4 inline-block text-[var(--neon-pink)]"
    ...
    >
        ...
        <div className="relative mx-auto flex min-h-[min(420px,50svh)] max-w-6xl flex-col justify-end px-4 pb-8 pt-12 sm:min-h-[min(520px,55svh)] sm:px-6 sm:pb-12 sm:pt-16">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full border border-white/20 bg-black/50 px-5 py-3.5 text-sm font-bold text-white backdrop-blur-md transition hover:border-[var(--neon-pink)]/50 hover:bg-black/60"
            >
              {t("home.useRecipe")}
            </Link>
            <Link
      ...
      <section className="border-b border-white/10 bg-gradient-to-b from-black via-[#08080c] to-black px-3 py-12 sm:px-5">
        <div className="mx-auto max-w-5xl">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--neon-pink)]/90">
            {t("home.proof")}
          </p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="overflow-hidden rounded-2xl bg-neutral-950 ring-1 ring-[var(--neon-pink)]/25 shadow-[0_24px_60px_-24px_rgba(196,165,116,0.2)]">
              ...
              <p className="p-3.5 text-xs font-bold uppercase tracking-wide text-[var(--neon-pink)]">
          ...
          <div className="mt-7 flex flex-wrap gap-2">
            ...
            <Link
              ...
              className="inline-flex rounded-full border border-white/20 bg-black/40 px-5 py-3.5 text-sm font-bold text-white/85 backdrop-blur transition hover:border-[var(--neon-pink)]/45"
            >
      ...
      <section className="px-3 py-10 sm:px-5">
        <div className="mx-auto max-w-6xl">
          <div className="mb-4 flex flex-wrap items-end justify-between gap-2">
            ...
            <Link
              href="/explore"
              className="text-[12px] font-semibold text-[var(--neon-pink)] hover:underline"
            >
              All projects →
            </Link>
          </div>
              ...
              >
                ...
                >
                  <div className="relative aspect-[3/4] sm:aspect-[9/14]">
                    ...
                    <div className="absolute left-2 top-2 flex max-w-[92%] flex-wrap gap-1">
                      <span className="rounded-full bg-black/70 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wide text-[var(--neon-pink)] ring-1 ring-white/10">
                ...
                <div className="absolute inset-x-0 bottom-0 flex gap-1 p-2">
                  ...
                  <Link
                    ...
                    className="rounded-full border border-white/20 bg-black/55 px-2.5 py-1.5 text-[10px] font-bold text-white backdrop-blur-sm transition hover:border-[var(--neon-pink)]/40"
                  >
                    {t("home.insideProject")}
                  </Link>
                </div>
      ...
      <section className="border-b border-white/10 px-3 py-8 sm:px-5">
        <div className="mx-auto max-w-6xl">
          <div className="mb-4 flex flex-wrap items-end justify-between gap-2">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--neon-pink)]">
                Creation flow
              </p>
              <h2 className="font-display text-xl font-bold uppercase tracking-tight sm:text-2xl">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-6">
            <div className="rounded-xl border border-white/10 bg-white/[0.03] px-3 py-3 transition hover:border-[var(--neon-pink)]/40 hover:bg-[var(--neon-pink)]/5">
              <FreeTrialCta
                path="/#jobs"
                labelTry="Try free video"
                labelDemo="Lab sample"
                hideClipsChip
                className="text-sm font-bold text-white hover:text-[var(--neon-pink)]"
              />
              <p className="text-[11px] text-white/40">Lab sample · 0 credits</p>
            </div>
            {[
              {
                href: "/create?effect=street-power-up",
              ...
              <Link
                key={c.href}
                href={c.href}
                className="rounded-xl border border-white/10 bg-white/[0.03] px-3 py-3 transition hover:border-[var(--neon-pink)]/40 hover:bg-[var(--neon-pink)]/5"
              >
      ...
      <section className="px-3 pb-6 sm:px-5">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-4 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-transparent p-5 sm:flex-row sm:items-center sm:p-6">
          ...
          <Link
            href="/create?effect=street-power-up"
            className="inline-flex shrink-0 items-center rounded-full border border-[var(--neon-pink)]/40 px-5 py-2.5 text-sm font-bold text-[var(--neon-pink)] transition hover:bg-[var(--neon-pink)]/10"
          >
            Create one Moment →
          </Link>
        </div>
      ...
      <section className="px-3 pb-10 text-center sm:px-5">
        ...
        <Link
          href={item.href}
          className="inline-flex items-center justify-center rounded-full bg-[var(--neon-pink)] px-8 py-3 text-sm font-black text-[var(--void)]"
        >
