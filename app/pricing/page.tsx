...
export default function PricingPage() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-x-0 top-0 h-80 bg-[radial-gradient(48%_80%_at_50%_0%,rgba(196,165,116,0.22),transparent_70%),radial-gradient(36%_60%_at_80%_10%,rgba(196,165,116,0.12),transparent_65%)]"
        aria-hidden
      />
      <script
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <div
            className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,var(--brand),var(--neon-pink),var(--tide-blue))]"
            aria-hidden
          />
          <div className="grid gap-8 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="rounded-full bg-[var(--grad-cta)] px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.13em] text-[var(--void)]">
                  Closed beta
                </span>
              </div>
              ...
              <Link
                ...
                className="mt-4 inline-block text-xs font-bold text-white/58 underline decoration-white/20 underline-offset-4 hover:text-[var(--tide-blue)]"
              >
            ...
            <div className="overflow-hidden rounded-[1.4rem] border border-white/12">
              <div className="border-b border-white/12 bg-white/[0.045] px-4 py-3">
                <p className="text-[9px] font-black uppercase tracking-[0.17em] text-[var(--tide-blue)]">
                  The product promise
                </p>
              </div>
