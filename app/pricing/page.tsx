...
export default function PricingPage() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-x-0 top-0 h-80 bg-[radial-gradient(48%_80%_at_50%_0%,rgba(196,165,116,0.18),transparent_70%),radial-gradient(36%_60%_at_80%_10%,rgba(196,165,116,0.1),transparent_65%)]"
        aria-hidden
      />
      <script
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <div
            className="absolute inset-x-0 top-0 h-1 [background:var(--grad)]"
            aria-hidden
          />
          <div className="grid gap-8 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="rounded-full px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.13em] text-[var(--primary-foreground)] [background:var(--grad)]">
                  Closed beta
                </span>
              </div>
