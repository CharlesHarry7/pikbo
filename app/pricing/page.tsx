...
export const metadata: Metadata = {
  title: "Pikbo Pricing · Founding Studio Private Beta",
  description:
...
/** Compact Day-1 free vs paid comparison (✓ / — symbols for scanability). */
...
/** Accordion FAQs — refund / offline / commercial (AIT-32 optional block). */
...
export default function PricingPage() {
  ...
  return (
    <div
      className="min-h-[calc(100svh-4rem)] bg-[var(--toy-ink)] px-4 py-10 text-[var(--toy-cream)] sm:px-8 sm:py-16"
    ...
    >
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--toy-fog)]">
            Lab Viewer free · Founding Studio private beta
          </p>
          <h1 className="mt-3 font-display text-[clamp(2.75rem,7vw,5.75rem)] font-black leading-[0.9] tracking-[-0.06em]">
            <span className="text-white">Pikbo</span>{" "}
            <span className="text-[var(--toy-fluo)]">Pricing</span>
          </h1>
          <p className="mx-auto mt-5 max-w-2xl font-sans text-sm font-medium leading-6 text-[var(--toy-cream)]/85 sm:text-lg sm:leading-7">
            ...
            for $49/month. Public payment remains locked until every
            private-delivery and billing gate passes.
          </p>
        </div>

        <div className="mt-9 grid gap-5 lg:mt-12 lg:grid-cols-2 lg:items-stretch">
          {/* Lab Viewer — collection-card free anchor */}
          <article
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2 pr-10">
              ...
              <span className="rounded-full bg-[var(--toy-fluo)] px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.13em] text-[var(--toy-ink)]">
                Closed beta
              </span>
            </div>
            ...
            <div className="mt-6 overflow-hidden rounded-[1.4rem] border border-white/12">
              ...
              {STUDIO_VALUE.map(([name, value, note], index) => (
                ...
                >
                  ...
                  <span className="self-center rounded-full border border-white/14 px-2.5 py-1 text-[10px] font-black text-[var(--toy-neon)]">
                    {value}
                  </span>
                </div>
              ))}
        ...
        >
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-sm font-medium leading-6 text-[var(--toy-cream)]/60">
        ...
        >
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            {pricingFaqItems.map((item) => (
              ...
              >
                <h3 className="text-sm font-black leading-5 text-[var(--toy-cream)]">
                  {item.question}
                </h3>
                <p className="mt-3 text-xs font-medium leading-5 text-[var(--toy-cream)]/55">
                  {item.answer}
                </p>
              </article>
            ))}
        ...
        {/* Optional accordion: refund / offline / commercial */}
        <section
