  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <div
            className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,#c4a574,#a89070,#9a7b55)]"
            aria-hidden
          />
          <div className="grid gap-8 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="rounded-full bg-[linear-gradient(135deg,#c4a574,#a89070)] px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.13em] text-white">
                  Closed beta
                </span>
              </div>
              ...
              <Link
                ...
                className="mt-4 inline-block text-xs font-bold text-white/58 underline decoration-white/20 underline-offset-4 hover:text-[#c4a574]"
              >
            ...
            <div className="overflow-hidden rounded-[1.4rem] border border-white/12">
              <div className="border-b border-white/12 bg-white/[0.045] px-4 py-3">
                <p className="text-[9px] font-black uppercase tracking-[0.17em] text-[#c4a574]">
                  The product promise
                </p>
              </div>
              {STUDIO_VALUE.map(([name, value, note], index) => (
                ...
                >
                  ...
                  <span className="self-center rounded-full border border-[#c4a574]/35 bg-[#c4a574]/10 px-2.5 py-1 text-[10px] font-black text-[#c4a574]">
                    {value}
                  </span>
                </div>
              ))}
