...
const EXPLORE_FAQ = [
  ...
  },
  {
    ...
    a: "No. Cached Lab playback costs 0 credits and does not process your upload. When Live is enabled for an eligible account, Generate shows the exact credit quote before submission; protected live delivery remains gated.",
  },
] as const;
