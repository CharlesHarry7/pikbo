    ...
    <main className="min-h-screen bg-black pb-24 text-white">
      ...
      <header className="sticky top-0 z-20 border-b border-white/10 bg-black/90 px-4 py-4 backdrop-blur sm:px-6">
        <div className="mx-auto flex max-w-7xl flex-wrap items-end justify-between gap-4">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.16em] text-neon-pink">
          ...
          >
            ...
            <Link
              ...
              className="rounded-full border border-neon-pink/40 bg-neon-pink/10 px-5 py-2.5 text-xs font-black text-neon-pink transition hover:bg-neon-pink/15"
