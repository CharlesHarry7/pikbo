...
export const metadata: Metadata = {
  ...
  description:
    "Search-intent toy video tools: image-to-video, listing clips, unboxing hooks, and seller demos. Each page deep-links to a real Create recipe; public path is cached Lab (0 credits), Live remains gated.",
  ...
  openGraph: {
    ...
    description:
      "One search job per page — open a registered recipe, preview a cached Lab sample, Live remains gated.",
    url: `${site.url}/tools`,
  },
};
...
const TOOLS_FAQ = [
  {
    ...
    a: "One search job: intent title, a working Create deep-link with a registered recipe, honest public Lab limits, and FAQ. Not a multi-model marketplace.",
  },
  {
    q: "Does Try free burn credits?",
    a: "Public Try free is a labeled cached Lab prototype at 0 credits and does not process your upload. When Live is enabled for an eligible account, Generate shows the exact quote before submission. Lab demos stay free.",
  },
  {
    ...
    <div className="relative px-4 py-10 sm:px-8">
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[var(--fg-muted)]">
          ...
          Create deep-link, cached Lab preview free (0 credits), Live remains
          gated, and honest FAQ. No unlimited generation and no guaranteed sales.
        </p>
