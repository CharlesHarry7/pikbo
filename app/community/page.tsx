...
const COMMUNITY_FAQ = [
  ...
  {
    q: "Do Lab demos use live credits?",
    a: "Cached Lab playback costs 0 credits and never processes your upload. When Live is enabled for an eligible account, a configured free-plan clip (about 5s · 480p · on-player mark) may spend live credits. After any trial, Lab still free; public Live stays gated.",
  },
] as const;
