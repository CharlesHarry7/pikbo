...
const COMMUNITY_FAQ = [
  ...
  },
  {
    ...
    a: "Cached Lab playback costs 0 credits and never processes your upload. Live remains gated; when Live is enabled for an eligible account, Generate shows the exact quote. Lab stays free either way.",
  },
] as const;
