...
const COMMUNITY_FAQ = [
  ...
  },
  {
    ...
    a: "When Live is enabled for an eligible account, generate a paid/clean deliverable → open Library → Publish to Community (sign-in required). Lab demos and free-plan raw provider files cannot be posted as public UGC (T6).",
  },
  {
  ...
  },
  {
    ...
    a: "No. Cached Lab playback costs 0 credits and does not process your upload. Live remains gated for eligible invited accounts; Generate shows the exact quote only when Live is enabled.",
  },
] as const;
      ...
      <section className="mx-auto max-w-7xl px-3 pb-10 pt-4 sm:px-5">
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5 sm:p-7">
          ...
          <p className="mt-1 text-xs text-white/40">
            Lab only · not UGC · Remix · cached Lab · Live gated
          </p>
