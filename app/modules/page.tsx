...
function ModuleCard({
  ...
  return (
    <Link
      href={w.href}
      className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] via-[#0c0c10] to-black shadow-[0_16px_40px_-28px_rgba(0,0,0,0.9)] transition duration-300 hover:-translate-y-1 hover:border-[var(--mint)]/45 hover:shadow-[0_24px_56px_-24px_rgba(255,78,205,0.15)]"
    ...
    >
      {poster ? (
        <div className="relative aspect-[3/4] overflow-hidden bg-black/50 sm:aspect-[4/5]">
          ...
          <span className="pointer-events-none absolute right-2 top-2 rounded-full bg-[var(--mint)] px-2 py-0.5 text-[9px] font-black uppercase tracking-wide text-void opacity-0 shadow-[0_0_16px_rgba(255,78,205,0.35)] transition group-hover:opacity-100">
            Remake
          </span>
          <div className="absolute bottom-14 left-3 right-3 flex flex-wrap gap-1">
            <span
              className={`rounded-full px-1.5 py-0.5 text-[9px] font-bold ${
                isLive
                  ? "bg-[var(--mint)] text-void shadow-[0_0_16px_rgba(255,78,205,0.35)]"
    ...
    <div className="min-h-[calc(100vh-3.5rem)] pb-28 lg:pb-0">
      ...
      <div className="sticky top-0 z-20 border-b border-white/10 bg-black/90 px-3 py-3 backdrop-blur-xl sm:px-5">
        <div className="mx-auto flex max-w-[1400px] flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-neon-pink">
              Modules · video jobs
            </p>
        ...
        <div className="relative mx-auto max-w-[1400px]">
          ...
          >
            <Link
              ...
              className="rounded-full border border-neon-pink/40 bg-neon-pink/10 px-3 py-1.5 text-neon-pink"
          ...
          <section>
            <div className="mb-3 flex items-end justify-between gap-3">
              <h2 className="text-[10px] font-black uppercase tracking-[0.16em] text-neon-pink">
          ...
          <section className="mt-12 rounded-2xl border border-white/10 bg-black/40 p-5 sm:p-7">
            ...
            <ol className="mt-4 grid gap-3 sm:grid-cols-3">
              {[
                ...
                >
                  <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[var(--mint)] text-[11px] font-black text-void">
                    {s.n}
                  </span>
