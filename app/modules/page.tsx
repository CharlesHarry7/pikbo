...
function ModuleCard({
  ...
  return (
    <Link
      href={w.href}
      className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] via-[#0c0c10] to-black shadow-[0_16px_40px_-28px_rgba(0,0,0,0.9)] transition duration-300 hover:-translate-y-1 hover:border-[var(--neon-pink)]/45 hover:shadow-[0_24px_56px_-24px_rgba(255,78,205,0.15)]"
    ...
    >
      {poster ? (
        <div className="relative aspect-[3/4] overflow-hidden bg-black/50 sm:aspect-[4/5]">
          ...
          <span className="pointer-events-none absolute right-2 top-2 rounded-full bg-[var(--neon-pink)] px-2 py-0.5 text-[9px] font-black uppercase tracking-wide text-[var(--void)] opacity-0 shadow-[0_0_16px_rgba(255,78,205,0.35)] transition group-hover:opacity-100">
            Remake
          </span>
      ...
      <div className={poster ? "p-3 pt-3" : "p-5 pt-4"}>
        <h3
          className={`font-bold tracking-tight transition group-hover:text-[var(--neon-pink)] ${
        ...
        <p className="mt-2 inline-flex items-center gap-1 text-[11px] font-bold text-[var(--neon-pink)]">
          ...
          <section className="mt-12 rounded-2xl border border-white/10 bg-black/40 p-5 sm:p-7">
            ...
            <ol className="mt-4 grid gap-3 sm:grid-cols-3">
              {[
                ...
                >
                  <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[var(--neon-pink)] text-[11px] font-black text-[var(--void)]">
                    {s.n}
                  </span>
