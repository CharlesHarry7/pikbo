...
function ModuleCard({
  ...
  return (
    <Link
      href={w.href}
      className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] via-bg-soft to-void shadow-[0_16px_40px_-28px_rgba(0,0,0,0.9)] transition duration-300 hover:-translate-y-1 hover:border-[var(--mint)]/45 hover:shadow-[0_24px_56px_-24px_color-mix(in_srgb,var(--neon-pink)_15%,transparent)]"
    ...
    >
      {poster ? (
        <div className="relative aspect-[3/4] overflow-hidden bg-black/50 sm:aspect-[4/5]">
          ...
          <span className="pointer-events-none absolute right-2 top-2 rounded-full bg-[var(--mint)] px-2 py-0.5 text-[9px] font-black uppercase tracking-wide text-black opacity-0 shadow-[0_0_16px_color-mix(in_srgb,var(--neon-pink)_35%,transparent)] transition group-hover:opacity-100">
            Remake
          </span>
