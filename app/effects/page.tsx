...
const EFFECTS_FAQ = [
  ...
  },
  {
    ...
    a: "Watching Lab demos costs 0 credits and never processes your upload. When Live is enabled for an eligible account, a configured free-plan clip (about one 5s · 480p · on-player mark) or paid credits may apply. Public Live stays gated — Lab still free.",
  },
  {
