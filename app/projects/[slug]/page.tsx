    ...
    <main className="min-h-screen bg-black px-4 py-8 text-white sm:px-8 sm:py-12">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mb-7 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full bg-[var(--brand)] px-2.5 py-1 text-[10px] font-black uppercase tracking-wide text-[var(--primary-foreground)] shadow-[0_0_20px_rgba(196,165,116,0.25)]">
                Inside project
              </span>
          ...
          >
            <Link
              ...
              className="inline-flex w-full items-center justify-center rounded-full bg-[var(--grad-cta)] px-7 py-3.5 text-sm font-black text-[var(--primary-foreground)] shadow-[0_0_40px_rgba(196,165,116,0.25)] transition hover:-translate-y-0.5 hover:shadow-[0_0_48px_rgba(196,165,116,0.35)]"
            >
              Use this recipe →
            </Link>
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-2">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/[0.03] px-4 py-2 text-[11px] font-bold text-white/80 transition hover:border-[var(--brand)]/40 hover:text-[var(--brand)]"
              >
                Create one Moment
              </Link>
              <Link
        ...
        >
          ...
          <article className="overflow-hidden rounded-2xl border border-[var(--brand)]/30 bg-white/[0.03] shadow-[0_20px_50px_-28px_rgba(196,165,116,0.12)]">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
              <div>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <dl className="mt-4 grid gap-x-8 gap-y-4 text-sm sm:grid-cols-2">
              ...
              <div>
                ...
                <dd className="mt-1 font-semibold text-[var(--brand)]">
                  {provenance}
                </dd>
              </div>
              <div>
          ...
          <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
              ...
              <span
                className={`rounded-full border px-2.5 py-1 text-[9px] font-black uppercase tracking-wide ${
                  promoted && evidenceComplete
                    ? "border-[var(--brand)]/35 bg-[var(--brand)]/10 text-[var(--brand)]"
              ...
              {evidenceChecklist.map((item) => (
                <div
                  ...
                  className={`flex items-center gap-2 rounded-lg border px-2.5 py-2 text-[10px] font-semibold ${
                    item.complete
                      ? "border-[var(--brand)]/25 bg-[var(--brand)]/[0.06] text-white/75"
            ...
            <div className="mt-6 grid gap-2" data-project-footer="product-first">
              <Link
                href={showcaseRecipeHref(project)}
                className="rounded-full bg-[var(--grad-cta)] px-5 py-3 text-center text-sm font-black text-[var(--primary-foreground)] shadow-[0_0_28px_rgba(196,165,116,0.2)] transition hover:-translate-y-0.5"
              >
                Use this recipe →
              </Link>
              <Link
                href={`/effects/${project.recipeSlug}`}
                className="rounded-full border border-white/15 bg-white/[0.03] px-5 py-3 text-center text-sm font-bold text-white transition hover:border-[var(--brand)]/40"
              >
