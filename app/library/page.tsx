...
export default function LibraryPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[var(--void)] px-4 py-8 text-[var(--cream)] sm:px-8 sm:py-12">
      <div
        className="pointer-events-none absolute inset-x-0 top-0 h-96 bg-[radial-gradient(42%_80%_at_8%_0%,rgba(196,165,116,0.16),transparent_72%),radial-gradient(36%_70%_at_92%_0%,rgba(196,165,116,0.1),transparent_68%)]"
        aria-hidden
      />
      <div className="relative mx-auto max-w-7xl">
        <section className="toy-card mb-8 p-5 sm:p-8">
          ...
          <div className="mt-7 grid gap-3 sm:grid-cols-3">
            {[
              ["Private", "Only your account can access these results", "var(--neon-pink)"],
              ["Recoverable", "Finished videos return after refresh", "var(--tide-blue)"],
              ["Ready to use", "Download or generate the Moment again", "var(--tide-green)"],
