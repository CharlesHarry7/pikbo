...
export default function Home() {
  ...
  // AIT-55: Moment hero first, then ≤8 cached Lab proof cards (HOME_PROOF_SLUGS).
  // Wall fragment only — no full Explore remount, Seller Pack, or Modules rails.
  const labProofWall = buildHomeShowcaseFeed();
  ...
  return (
    <>
      ...
      <HomeCinemaHero />
      <HomeViralWall items={labProofWall} />
      <HomeTrustFooter />
    </>
  );
}
