...
export default async function CreatePage({
  ...
  return (
    <GuestMomentCreateGate>
      ...
      >
        <div
          className="pointer-events-none absolute inset-x-0 top-0 h-72 bg-[radial-gradient(50%_80%_at_12%_0%,rgba(196,165,116,0.18),transparent_70%),radial-gradient(40%_60%_at_88%_0%,rgba(196,165,116,0.1),transparent_65%)]"
          aria-hidden
        />
        <div className="relative mx-auto grid max-w-[1480px] gap-4 border-b border-[var(--neon-pink)]/15 px-5 py-5 sm:px-8 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-end lg:px-12">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--neon-pink)]">
