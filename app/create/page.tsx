  ...
  if (contract === "generate-workbench") {
    ...
    return (
      ...
      >
        ...
        />
        <div
          className="pointer-events-none absolute inset-x-0 top-0 h-72 bg-[radial-gradient(50%_80%_at_12%_0%,rgba(196,165,116,0.18),transparent_70%),radial-gradient(40%_60%_at_88%_0%,rgba(138,143,152,0.12),transparent_65%)]"
          aria-hidden
        />
