        ...
        <div className="card mt-6 grid gap-5 p-5 sm:p-6 lg:grid-cols-2">
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="mt-2 w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2.5 text-sm outline-none focus:border-[var(--mint)]/50 focus:shadow-[0_0_0_3px_color-mix(in_srgb,var(--neon-pink)_10%,transparent)]"
            />
