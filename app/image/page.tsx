...
export default function ImageStudioPage() {
   ...
   *
   * AIT-211: durable owner UUIDs never invent process-memory fork success —
   * honest Create/Image new-attempt handoff only; IN_FLIGHT / SUCCEEDED stay
   * fail-closed with no silent re-POST.
   */
