...
| K3-WAVE-A-POLISH | Human-directed Wave A frontend polish: premium toy art direction + original asset redo on top of `agent/gpt/higgsfield-wave-a` | K3 | review | `agent/k3/wave-a-frontend-polish` | Hero brand film + key visual, 4 character stills, 27 recipe covers, concept covers as static art, recipe-wall covers, seller campaign band, project input→output marker; registry in docs/ASSETS.md; no API/credit/provider/persistence changes |
