...
| H-HOME-CONTENT | Content-first toy homepage: watch → expand → remake → upload | Codex | **review** | agent/gpt/home-content-first | Multilingual video hero; Premiere + dense previews; in-page viewer; sticky CTA; three values; long SEO collapsed |
