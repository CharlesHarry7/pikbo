...
| SEO-GSC | GSC VideoObject + crawl/noindex contract | Grok | **doing** | agent/grok/seo-gsc-p0 | uploadDate DateTime; robots allow Preview crawl; sitemap stays 9; boss validate in GSC after deploy |
