...
| R1c | Durable settlement reconciliation worker | Claude / Grok | todo | — | Capture ambiguity and provider output after cancel/timeout remain withheld/pending; do not enable live until durable reconciliation closes them |
