...
| R2 | One owned-toy photo → three publishable assets → export Launch Pack | Codex | **doing** | agent/gpt/launch-pack-main-path | Claimed 2026-07-28 after SELLER-GOLD merged. Unify the homepage/Create path, keep the fixed listing/reveal/hook contract, expose one honest Launch Pack export, and lock the ≤3-primary-action acceptance without opening Live |
