...
| UI-q | UI quality r1–r3 aesthetic | Grok | review | main | Create + Seller Pack first-run 390px; compact pack steps; sticky upload/generate/library/retry-failed; smoke locked |
