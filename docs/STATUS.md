...
|---|---|---|---|---|---|
| K3-WAVE-A-VISUAL-V2 | Replace rejected four-character Hero with one original, Xiaohongshu-researched proof-led character world | K3 + Codex | review | `agent/k3/wave-a-frontend-polish` · Draft PR #78 | Direction A selected 30/30; Home Hero + eight unified Recipe covers, input/set/output truth split, legacy registered project posters restored; full local and PR checks required before done |
