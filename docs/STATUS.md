...
| R1b | Explicit retry token + fixed deadline + settlement reconciliation | Grok / Claude | review | main | Process-memory retryJobId promote + createdAt deadline shipped; capture-ambiguity client honest; durable reconciliation worker + SQL apply still open |
