...
- Codex integration review synchronized the live `.github/workflows/ci.yml` to the reviewed fail-closed template; GitHub Actions must still finish green on the integration PR/main.
