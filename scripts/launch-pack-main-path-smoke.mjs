...
assert.match(homeHero, /lcpPosterFirst/);
assert.doesNotMatch(homeHero, /\beager\b/);
assert.match(home, /beatbot-still\.webp/);
assert.match(home, /rel=["']preload["'][\s\S]*fetchPriority=["']high["']/);
assert.match(homeWall, /DeferredWallVideo/);
