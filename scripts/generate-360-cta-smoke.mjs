...
// AIT-577: Explore page residual competitor lime → gallery-calm copper
const explorePageSrc = read("app/explore/page.tsx");
assert.doesNotMatch(
  explorePageSrc,
  /#c8ff3d|c8ff3d|200\s*,\s*255\s*,\s*61/i,
...
const effectsPageSrc = read("app/effects/page.tsx");
assert.doesNotMatch(
  effectsPageSrc,
  /#c8ff3d|c8ff3d|200\s*,\s*255\s*,\s*61/i,
