...
// 8. AIT-369 Home HF Explore density residual — Generate→360 continuity
...
assert.match(
  homeStack,
  /HomeCinemaHero[\s\S]*HomeViralWall[\s\S]*HomeExploreRecipeRail[\s\S]*HomeBrowseCta[\s\S]*HfProductRail/,
  "home entry: Moment hero → proof wall → explore rail → browse CTA → suite rail"
);
