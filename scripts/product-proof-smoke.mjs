...
// AIT-404: Flow page residual lime → neon-pink board tokens
{
  const flowPage = read("app/flow/page.tsx");
  assert(
    !/#c8ff3d|c8ff3d|200\s*,\s*255\s*,\s*61/.test(flowPage),
    "Flow page must not hard-code competitor lime (#c8ff3d / rgba 200,255,61)"
  );
  assert(
    flowPage.includes("var(--neon-pink)") &&
      flowPage.includes("var(--void)") &&
      flowPage.includes("rgba(255,78,205"),
    "Flow page primary chrome uses neon-pink / void board tokens"
  );
}
