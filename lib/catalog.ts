...
export const MODELS: CatalogModel[] = [
  ...
  },
  {
    ...
    tag: "Access gated",
    blurb:
      "Configured Mini recipe for eligible accounts; cached Lab previews remain the public fallback.",
  ...
  },
  {
    ...
    kind: "image",
    tag: "Access gated",
    blurb: "High-detail product-board recipe; runtime eligibility is checked before a provider call.",
    href: "/image",
