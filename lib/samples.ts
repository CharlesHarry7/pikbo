 ...
 * Bounded by default so one-tap Lab preview cannot hang forever.
 */
export async function sampleToDataUrl(
  path: string,
  ...
  return withTimeout(load(), timeoutMs, "Lab sample load timed out");
}
