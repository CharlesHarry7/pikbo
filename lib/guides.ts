...
export const GUIDES: Guide[] = [
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Confirm Etsy’s current file rules (length, format, size) before you generate a batch. Public validation is a cached Lab prototype at 0 credits — enough to judge a hook look. When Live is enabled for an eligible account, Generate shows duration, resolution, and the exact quote.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Open the Etsy use-case landing or Generate with a listing recipe. Confirm you own the photo. Start with a cached Lab preview; only submit Live when eligibility and quote are shown. Wait for the full render (often 1–3 minutes) and download only after visual QA.",
          "Live and public checkout stay closed until validation gates pass. Failed Live jobs refund the credit debit only when the server confirms release.",
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    emoji: "🆓",
    title: "Free AI Toy Video Generator — What the Public Free Path Includes",
    ...
    sections: [
      {
        h2: "What the public free path is",
        paragraphs: [
      ...
      {
        h2: "What the public free path is not",
        paragraphs: [
          "It is not unlimited 4K, not Kling/Runway multi-model switching, and not a guarantee of sales or virality. Stripe checkout stays closed until billing is intentionally enabled.",
          "Product-cap Free Mini language only appears when Live is actually open for an eligible account — not as an unconditional public trial promise.",
        ],
      },
      {
  ...
  },
  {
    ...
    seoDescription:
      "Compare designer toy AI video with generic photo-to-video apps. Owned photos, listing recipes, honest Lab vs Live limits — not fake multi-model theater.",
    readMins: 6,
    intro:
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: "Is the free path the same as free unboxing toys?",
