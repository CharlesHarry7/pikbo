...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    emoji: "🆓",
    title: "Free AI Toy Video Generator — What Soft Launch Actually Includes",
    dek: "Honest soft-launch limits so searchers are not sold unlimited generation.",
    seoTitle: "Free AI Toy Video Generator Limits | Pikbo Lab free",
    seoDescription:
    ...
    sections: [
      {
        h2: "What the free public path is",
        paragraphs: [
      ...
      {
        h2: "What free validation is not",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Honest Lab free path vs unlimited claims",
        paragraphs: [
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: "Is the free Lab path the same as free unboxing toys?",
