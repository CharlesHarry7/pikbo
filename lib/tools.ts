...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Public path is cached Lab · 0 credits and never processes your photo. Live stays gated for eligible accounts. Keep the browser tab open until a Live job finishes or credits may look wrong until refresh.",
    ],
    keywords: [
      "toy image to video",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Cached Lab prototypes are short samples (about 5s). When Live is enabled for an eligible account, Generate shows the configured duration, resolution, and exact credit quote.",
      },
    ],
  },
  {
    ...
    seoTitle: "Toy Product Video AI: Listing Clips, Lab free | Pikbo",
    seoDescription:
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: "What length?",
        a: "Public Lab previews are short samples sized for a vertical hook. Eligible Live jobs show the exact duration and resolution quote before you submit.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    seoTitle:
      "Toy Unboxing Hook Video From One Photo — Lab free | Pikbo",
    seoDescription:
  ...
  },
  {
    ...
    body: [
      ...
      "Soft launch public path is cached Lab · 0 credits — enough to preview a hook; do not expect unlimited free Live exports.",
  ...
  },
  {
    ...
    body: [
      ...
      "Public Lab validates the recipe look for one hero SKU at 0 credits; batch more when Live or paid credits are available.",
  ...
  },
  {
    ...
    body: [
      ...
      "Keep claims honest: public path is labeled cached Lab samples; Live Seedance access stays gated for eligible accounts.",
